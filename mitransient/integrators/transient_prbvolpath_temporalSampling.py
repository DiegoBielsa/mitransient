...
class TransientPRBVolpathIntegratorTimeSampling(TransientADIntegrator):
    r"""
    .. _integrator-transient_prbvolpath_timeSampling:

    Transient Volumetric Integrator (:monosp:`transient_prbvolpath_timeSampling`)
    -------------------------------------------------------------------------
    ...
    def sample(self,
        ...
        if mode == dr.ADMode.Forward:
            raise RuntimeError("TransientPRBVolpathIntegratorTimeSampling doesn't support "
...
mi.register_integrator("transient_prbvolpath_timeSampling",
                       lambda props: TransientPRBVolpathIntegratorTimeSampling(props))
